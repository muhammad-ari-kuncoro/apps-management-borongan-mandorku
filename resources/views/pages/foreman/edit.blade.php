...
@section('container')
    <div class="container-fluid py-4">
       ...
       @include('layouts.flash-data');
        <form action="{{ route('foreman.update', $dataForemanByID->id) }}" method="POST">
            @csrf
            @method('PUT')
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" name="nik"
                                        ...
                                        value="{{ old('nik', $dataForemanByID->nik) }}"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" name="no_phone"
                                        ...
                                        value="{{ old('no_phone', $dataForemanByID->no_phone) }}"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        value="{{ old('name', $dataForemanByID->name) }}"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" name="full_name"
                                        ...
                                        value="{{ old('full_name', $dataForemanByID->full_name) }}"
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <select name="gender" class="form-select @error('gender') is-invalid @enderror">
                                        ...
                                        <option value="laki-laki" {{ old('gender', $dataForemanByID->gender) == 'laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                        <option value="perempuan" {{ old('gender', $dataForemanByID->gender) == 'perempuan' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="number" name="age" min="17" max="99"
                                        ...
                                        value="{{ old('age', $dataForemanByID->age) }}"
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="text" name="spesialist"
                                        ...
                                        value="{{ old('spesialist', $dataForemanByID->spesialist) }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="address" rows="3"
                                        ...
                                        placeholder="Masukkan alamat lengkap">{{ old('address', $dataForemanByID->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="date" name="join_date"
                                        ...
                                        value="{{ old('join_date', $dataForemanByID->join_date?->format('Y-m-d')) }}">
                                    @error('join_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="date" name="terminate_date"
                                        ...
                                        value="{{ old('terminate_date', $dataForemanByID->terminate_date?->format('Y-m-d')) }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="daily_rate" name="daily_rate" min="0" step="0.01"
                                    ...
                                    value="{{ old('daily_rate', $dataForemanByID->daily_rate) }}"
                                    placeholder="0">
                                @error('daily_rate')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror">
                                <option value="active"    {{ old('status', $dataForemanByID->status) == 'active'    ? 'selected' : '' }}>Active</option>
                                <option value="inactive"  {{ old('status', $dataForemanByID->status) == 'inactive'  ? 'selected' : '' }}>Inactive</option>
                                <option value="terminate" {{ old('status', $dataForemanByID->status) == 'terminate' ? 'selected' : '' }}>Terminate</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column gap-2">
                                <div class="d-flex justify-content-between small">
                                    ...
                                    <span class="fw-semibold">{{ $dataForemanByID->created_at->format('d M Y, H:i') }}</span>
                                </div>
                                <div class="d-flex justify-content-between small">
                                    <span class="text-muted">Diupdate</span>
                                    <span class="fw-semibold">{{ $dataForemanByID->updated_at->format('d M Y, H:i') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
