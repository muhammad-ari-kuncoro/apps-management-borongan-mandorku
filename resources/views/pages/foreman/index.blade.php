    ...
    <div class="container-fluid py-4">
        ...
        <div class="card border-0 shadow-sm">
            <div
                ...
                <a href="{{ route('foreman.create') }}" class="btn btn-primary btn-sm">
                    <i class="bi bi-plus-circle me-1"></i> Tambah Data Foreman
                </a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @forelse ($dataForeman as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->status }}</td>
                                    <td>
                                        <a href="{{ route('foreman.edit', $data->id) }}" class="btn btn-sm btn-warning">
